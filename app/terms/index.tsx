  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={true}>
        ...
        <Text style={[styles.text, { color: colors.text }]}>
          Avigate is a mobile navigation application designed to help residents and visitors
        ...
        <Text style={[styles.text, { color: colors.text }]}>
          ...
          facilitate, or provide transportation services. We are an information and navigation tool
          that helps you use existing public transportation systems.
        </Text>
        ...
        <Text style={[styles.text, { color: colors.text }]}>
          Any feedback, suggestions, or contributions you provide to Avigate may be used by us
          without compensation or attribution. By submitting such content, you grant us a worldwide,
          perpetual, irrevocable, royalty-free license to use, modify, reproduce, and incorporate
          such content into the Service.
        </Text>

        <Text style={[styles.sectionTitle, { color: colors.text }]}>
          7. Location Services and Accuracy
        </Text>
        ...
        <Text style={[styles.subsectionTitle, { color: colors.text }]}>
          8.2 No Transportation Provider
        </Text>
        <Text style={[styles.text, { color: colors.text }]}>
